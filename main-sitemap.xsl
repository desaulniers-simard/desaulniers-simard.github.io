			...
			<body>
				<div id="content">
					...
					<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
						...
						<p class="expl"><a href="https://desaulniers-simard.com/sitemap_index.xml">&#8593; Sitemap Index</a></p>
						<table id="sitemap" cellpadding="3">
							<thead>
								<tr>
									<th width="75%">URL</th>
				...
				<script type="text/javascript" src="https://desaulniers-simard.com/wp-content/plugins/wordpress-seo/js/jquery.tablesorter.min.js"></script>
